...
<th>Usuario</th>  
<th>Destinos</th> 
<th>Vehiculos <br> Choferes </th>  
<th>Credito <br> Comision</th> 
...
$sql = "SELECT IdEmpresa, RzonSocial, RLegal, Domicilio, Correo, Telefono, Contacto, Usuario, Contrasena, RFC FROM empresa where tusuario = '1' and activo = '1'";
...
<input type='hidden' name='idempresa' value='".$row["IdEmpresa"]."'>     
<td><input style='width:70px;' type='Submit' name='Vehiculos' value='Vehiculos'></td> 
</form>
<form name='forma' method='post' action='Credito'> 
<input type='hidden' name='idempresa' value='".$row["IdEmpresa"]."'>  
<td><input type='Submit' style='width:70px;' name='Credito' value='Credito'></td>
</form>
...
echo"
<input style='width:70px;' type='Submit' name='actualizar' value='Actualizar'>
</form>";
...
<div align="center" id="AcuseFinal"  hidden >   <h3> COMERCIALIZADORA PETROMAR SA DE CV </h3> <br>
         ...
         <?php 
		 $sql = "SELECT RzonSocial, RFC, RLegal, Domicilio, Correo, Contacto, Telefono,Usuario  FROM empresa where IdEmpresa = '".$_POST['Acuse']."'";
		  ...
		  <label style='font-weight:bold;'> Representante Legal:</label> ".$row['RLegal']."  <br>
		   ...
		   <label style='font-weight:bold;'> Contacto: </label>".$row['Contacto']." <br>
            <label style='font-weight:bold;'>Domicilio: </label>".$row['Domicilio']." <br>
             ...
             <label style='font-weight:bold;'>Correo: </label>".$row['RzonSocial']." <br>
