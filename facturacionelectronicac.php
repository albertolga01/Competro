...
<!-- FIN DEL ENCABEZADO --> 
	...
	<div id="maincontent" align="center"> 	
       ...
       <form name="forma1" method="post" action="facturacionelectronicarc.php">
        ...
        <tr>
			...
			<td class="color_blanco">
				<select name="tipo">
						...
						<option value="FP" selected>Facturas de producto
...
echo "<tr>
<form name='forma' method='post' action='controlador/updatepedidoc.php'> 
