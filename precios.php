...
<script>
    ...
    var ajax = new XMLHttpRequest();  
     var Fecha = document.getElementById("fechaaa");
      var Magna = document.getElementById("magna");
	   ...
	   var value = 0;
	ajax.open("GET", "data/dataproductos.php",true);
	ajax.send();
    ...
    ajax.onreadystatechange = function() {  
        if (this.readyState == 4 && this.status == 200) {
            ...
            Fecha.innerHTML = "Precios de venta aplicables para el día " + fechaa;
			Magna.innerHTML = '$' + magnaa;
            Premium.innerHTML = '$' + premiumm;
			Diesel.innerHTML = '$' + diesell;
