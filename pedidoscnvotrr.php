...
$myDate = date('d/m/Y');		
 ...
 $sql="";
				if (isset($_POST['fini'])) {
					$sql = "SELECT t1.IdCondicion, t1.CentroEntrega, t1.producto, t1.destino, t1.mediot, t1.tipom, t1.entrega FROM condiciones t1   where t1.idempresa = '".$_SESSION["idempresa"]."' and CentroEntrega = '".$_POST['CentroEntrega']."'"; 
				}else{
					
					$sql = "Select * from pedido where turno = '5'";
					}
...
echo "<tr> 
<form name='forma' method='post' action='controlador/postpedidod.php'> 
