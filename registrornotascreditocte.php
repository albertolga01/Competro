...
<script type="text/JavaScript">
            $("#un").load("controlador/tppagosa.php");
        </script>
    </p> 
...
<!-- FIN DEL ENCABEZADO --> 
			 ...
			 <div class="margin">
				<DIV id=pathway>
					<SPAN class=bullet>&nbsp;&nbsp;</SPAN> 
							 <a  href="menu_cte" >Servicio a clientes</a>&nbsp;<span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;<a  href="#" >Historial de notas de credito</a>
	...
	<div id="maincontent" align="center"> 	
       ...
       <form name="forma1" method="post" action="registrornotascreditocte">
...
$stringg = date('Y-m-d', strtotime($string));
  $sql = "Select t1.Folio, t1.empresa, t1.idempresa, t1.pdf, t1.concepto, t2.usuario, t1.NotaCredito, t1.Fecha, t1.Total from notascredito t1 inner join empresa t2 on t1.IdEmpresa = t2.IdEmpresa where date(Fecha) = '".$stringg."' and t1.IdEmpresa = '".$_SESSION['idempresa']."'";
