    ...
    <body class="body">
        ...
        <div id="contentfull" align="left">
            ...
            <div id="maincontent" align="center">
				...
				<form name="forma1" method="post" action="notascredito0_manual.php">
				<table>
				<tr><td class="color_blanco"><label>Seleccionar cliente: </label></td>
...
//echo "<option selected>TODOS</option>";
	...
	//echo "<option>TODOS</option>";
				...
				<tr><td align="center" colspan="2" class="color_blanco"><input type="submit" value="Aceptar"></td></tr>
				</table>
				</form>

                <form method="post" name="formatimbrado" id="formatimbrado" action="sw/timbrarNotasCreditoManual">
                <?php
                    if(true){
                            ...
                            $f = $_POST['Descuento'][0] - ($_POST['Descuento'][0] * $Comision);
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td><input for="cusat1" name="claveunidad"></input></td>
                                        ...
                                        <td><input for="descuentos1"></input></td>
