...
$ancho = $_GET['Ancho'];
    ...
    function sustituirEspacio($string){
        $quitar = ' ';
        $poner = '&nbsp;';
        $res = str_replace($quitar,$poner,$string);
        return $res;
    }
    function centavitos($string){
        $quitar = '.';
        $poner = '';
        $res = str_replace($quitar,$poner,$string);
        $tama = strlen($res);
    ...
    <body class="body">
        ...
        <div id="page">
            ...
            <div id="contentfull" align="left">
                ...
                <?php
                    $strtimbrado = '../uploads/F0000007126 SERBASAN F-51032860 M.xml';
                    if (file_exists($strtimbrado)) 
                    {
                     ...
                     //   $r= mysqli_query($connect, $querytimbrado);
                      ...
                      //  $TotalLetra = $fmt->format(str_replace(",","",substr($TotalesTotal, 0, -3)));
						
                        $a = number_format($TotalesTotal, 2);
                        ...
                        $SellodigitalCFDI = $TimbreFiscalDigital['SelloCFD']; 
                                    ...
                                    <div style="width: 755px;">
                                        <div style="display: flex; flex-direction: row;">
                                            ...
                                            <div style="display: flex; flex-direction: column; margin-left: auto; background-color: #d9d9d9; color: #0082b7;">
                                                <label><center>'.sustituirEspacio("COMERCIALIZADORA PETROMAR SA DE CV").'</center></label>
                                        ...
                                        <label>Número de permiso de comercialización otrogado por la comisión reguladora de energía H/22957/COM/2019</label>  
                                        ...
                                        <div class="toptable" style="display: flex; flex-direction: column;">
                                            ...
                                            <label >'.sustituirEspacio($Cliente).'</label>
                                            </div>
                                            ...
                                            <label>'.agregarsalto(strtoupper("carret. internacional km 223 presidente av miguel aleman y prolongacion perez arce. el rosario sin, cp 82800")).'</label>
                                            </div>
				            ...
				            for($i = 0; $i < $num; $i ++){
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="dt2" style="text-align: left;width:150px"><label for="condes1" style="max-width:100px">'.$Descripcion[$i].'&nbsp;pedido: '.$_POST['nopedido'].'</label></td>
		                ...
		                echo '
                                        ...
                                        <div style="display: flex;">
                                            <div style="display: flex; flex-direction: column;">
                                                ...
                                                <label style="display: inline-block; width: 520px;">'.ucwords(strtolower($TotalLetra)).'&nbsp;Pesos&nbsp;'.centavitos($TotalLetraCentavos).'/100&nbsp;M.N.</label>
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <label name="datosextra">'.$_POST['datosextra'].'</label>
                                        </div>
                                        <div>
                                            <label>Cantidad a 20°: </label>
                                            <label name="datosextra">'.number_format($Cantidad[0], 2).'</label>
                                        </div>
                                        <br>
                        ...
                        ';
// <body onload="setTimeout(function() { document.frmpost.submit() }, 5000)">   </body> 
                        echo '
                           
                                <form method="post" action="controladorad/postfactura3.php" name="frmpost"> 
                                    <input type="hidden" name="folio" value="'.$Folio.'" />
				    <input type="hidden" name="cantidadnatural" value="'.$_POST['datosextra'].'" />
                                    ...
                                    <input type="hidden" name="concepto" value="'.$Descripcion[0].' pedido: '.$_POST['nopedido'].'" />
            ...
            <input type="checkbox" id="checkbox" checked="true" onchange="Alert()"> Version tablet</input>
        </div>
