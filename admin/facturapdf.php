                                ...
                                <div class=WordSection1>
                                    ...
                                    <div style="width: 755px;">
                                        ...
                                        <div class="toptable" style="display: flex; flex-direction: column;">
                                            ...
                                            <label>'.ucwords(strtolower($Cliente)).'</label>
                                            </div>
                                            ...
                                            <label>'.ucwords(strtolower($Domicilio)).'</label>
                                            </div>

                                            <div style="flex-direction: row;">
                                            <label class="tt5">Lugar de entrega:</label>
                                            <label>'.ucwords(strtolower($DireccionEntrega)).'</label>
                                            </div> 
                                            <div style="flex-direction: row;">
				            ...
				            for($i = 0; $i < $num; $i ++){
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="dt2"><label for="objetoimpuesto1">02</label></td>
		                ...
		                echo '
                                        ...
                                        <div style="display: flex;">
                                            ...
                                            <div style="display: flex; flex-direction: column; margin-left: auto;">
                                                ...
                                                <div>
                                                <label class="total1">Impuestos Trasladados</label>
