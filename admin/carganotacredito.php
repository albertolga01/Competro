...
<a class='list' href='registrornotascredito' style="height: 30px; text-align: left; height:auto; padding:2px 0;">Historial de notas de credito</a>
<img src="img/line.png" width="175px" height="2px">
<div style=" height:30px;">
<a class='list' href='notascredito0_manual' style="height: 30px; text-align: left; height:auto; padding:2px 0;">Cargar nota de crédito manual</a></div>
