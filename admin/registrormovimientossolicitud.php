...
<!-- FIN DEL ENCABEZADO --> 
			 ...
			 <div class="margin">
				...
				<DIV id=pathway>
							...
							<SPAN class=bullet>&nbsp;&nbsp;</SPAN> 
							 ...
							 <a  href="menu_cteadmin" >Servicio a Clientes</a>&nbsp;<span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;<a  href="cargamovimientos.php" >Captura de Movimientos</a>&nbsp;<span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;
	...
	<div id="maincontent" align="center"> 	
       ...
       <form name="forma1" method="post" action="registrormovimientossolicitud">
...
if($tipo === 'Diario'){
	...
	echo '<form name="forma" method="post" action="controladorad/updatemovimientost.php"> 
...
$stringg = date('Y-m-d', strtotime($string));
  ...
  $sql = "Select t1.Folio, t2.usuario, t1.FechaCaptura, t1.Descripcion, t1.Comprobante, t1.Status from depositos t1 inner join empresa t2 on t1.IdEmpresa = t2.IdEmpresa where date(FechaCaptura) = '".$stringg."' ";
...
<td> <div align='center' style='width:130px;'><label >".$row["FechaCaptura"]."</label>
...
<td> <div align='center' style='width:110px;'> <a href='comprobantes/".$row["Comprobante"]."'>".$row["Comprobante"]."</a> </div></td>";
...
die("Connection failed: " . $connect->connect_error);
  ...
  $sqld = "select date(fechacaptura) as fecha from depositos where date(fechacaptura) >=  STR_TO_DATE('".$inicial."', '%d/%m/%Y') and date(fechacaptura) <= STR_TO_DATE('".$final."', '%d/%m/%Y') group by date(fechacaptura)";
...
$stringg = date('Y-m-d', strtotime($string));
   ...
   $sql = "Select t1.Folio, t2.usuario, t1.FechaCaptura, t1.Descripcion, t1.Comprobante, t1.Status from depositos t1 inner join empresa t2 on t1.IdEmpresa = t2.IdEmpresa where date(FechaCaptura) = '".$rowd['fecha']."'";
