...
<div id="contentHome" class="left" >
  ...
  <p class="titulo" align="center">Activar cuenta</p>
    ...
    <form  method="post"  class="login-form" action="activacion.php">
      ...
      <input type="password" placeholder="Nueva Contraseña" name="NvaContrasena" required="required"/>

      <input type="password" placeholder="Nueva Contraseña" name="CC" required="required"/>
