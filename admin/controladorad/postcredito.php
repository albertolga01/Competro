...
function Login()
{
	...
	global $connect;
	    ...
	    $query = "Insert into estadocuenta (IdEmpresa, Credito, LimC, Plazo, Porcentaje, PorcentajePremium, PorcentajeDiesel) values ('".$Id."','".$Activo."','".$LimC."','".$Plazo."','".$Porcentaje."','".$PorcentajeP."','".$PorcentajeD."')";
