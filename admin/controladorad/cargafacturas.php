...
<div id="cliente">
 ...
 <script type="text/JavaScript">
            $("#un").load("controladorad/cargafacturas.php");
        </script>
    </p> 
...
$cantidad = number_format($_POST['Cantidad'], 2, '.', ','); 
$descuento = number_format($_POST['Descuento'], 2, '.', ',');
$total = number_format($_POST['Total'], 2, '.', ','); 
$Importee = number_format($_POST['Importee'], 2, '.', ','); 
$impuestos = number_format($_POST['ImpuestosTrasladados'], 2, '.', ','); 
$impuestosretenidos = $_POST['ImpuestosRetenidos'];; 


$NoPedidoo = substr($_POST['Concepto'], -4);
if(isset($_POST['F'])){
	$flete = number_format($_POST['F'], 2, '.', ','); 
	}else{
		$flete = '';
		}

	echo '
	<input type="hidden" name="folio" readonly 	value="'.$_POST['Folio'].'">
	<input type="hidden" name="idempresa" readonly value="'.$_POST['idempresa'].'">
	<input type="hidden" name="factura" readonly value="'.$_POST['Factura'].'">
	<input type="hidden" name="importe" readonly value="'.$_POST['Importee'].'">
	<input type="hidden" name="fecha" readonly value="'.$_POST['Fecha'].'">
	<input type="hidden" name="total" readonly value="'.$_POST['Total'].'">
	<input type="hidden" name="pdf" readonly value="'.$_POST['PDF'].'" >
	<input type="hidden" name="flete" readonly value="'.$_POST['F'].'" >
	<input type="hidden" name="concepto" readonly value="'.$_POST['Concepto'].'" >
	<input type="hidden" name="rfc" readonly value="'.$_POST['Rfc'].'">
	<input type="hidden" name="valorunitario" readonly value="'.$_POST['ValorUnitario'].'">
	<input type="hidden" name="descuento" readonly value="'.$_POST['Descuento'].'">
	<input type="hidden" name="cantidad" readonly value="'.$_POST['Cantidad'].'" >
	<input type="hidden" name="impuestostrasladados" readonly value="'.$_POST['ImpuestosTrasladados'].'" >
	<input type="hidden" name="impuestosretenidos" readonly value="'.$_POST['ImpuestosRetenidos'].'" >
	<tr>
...
<label>$'.$_POST['ValorUnitario'].'</label>  <tr/><tr>
