...
{  
	...
	$cantidadnatural = $_POST["cantidadnatural"];
	$Uuid = $_POST["uuid"];
	$FP = $_POST["FP"];
    ...
    if ($ResPedido->num_rows > 0) {		 
		...
		$queryf = "Insert into facturas (Folio, IdEmpresa, Factura, Fecha, Total, pdf, NoPedido, Descuento, Cantidad, ValorUnitario,
            RFC, flete, Concepto, FechaVencimiento, Restante, Importe, ImpuestosTraslados, ImpuestosRetencion, Emisor, Uuid, FP, cantidadnatural) 
		    values ('".$Folio."', '".$IdEmpresa."','".$Factura."', '".$Fecha."', '".$Total."', '".$pdf."', '".$NoPedido."', '".$Descuento."', '".$Cantidad."', '".$ValorUnitario."', '".$Rfc."', '".$flete."', '".$Concepto."', '".$FechaV."', '".$Total."', '".$Importee."', '".$ImpuestosT."', '".$ImpuestosR."', 'Competro', '".$Uuid."', '".$FP."', '".$cantidadnatural ."')"; 
			...
			if ($resulttr->num_rows > 0) {
                ...
                if($Sobrante > 0){
                    if($Sobrante > $Total){
                        ...
                        $QInsert = "Insert into cargosaplicaciones (foliopago, Factura, Importe, FP, Moneda, FechaV, TipoPago, TadBanco,
                            Documento, Fecha, Abono, Intereses, IVA, IdEmpresa) 
                            values ('1', '".$Factura."','".$Total."','CONTADO','NACIONAL','".$Fecha."','PAGO CON RECIBO DE FONDOS',
...
{  
	global $connect; 
	    ...
	    $query = "Insert into facturas (Folio, IdEmpresa, Factura, Fecha, Total, pdf, NoPedido, Descuento, Cantidad, ValorUnitario, RFC, flete, Concepto, FechaVencimiento, Restante, Importe, ImpuestosTraslados, ImpuestosRetencion, Emisor, Uuid, FP,cantidadnatural) 
		values ('".$Folio."', '".$IdEmpresa."','".$Factura."', '".$Fecha."', '".$Total."', '".$pdf."', '".$NoPedido."', '".$Descuento."', '".$Cantidad."', '".$ValorUnitario."', '".$Rfc."', '".$flete."', '".$Concepto."', '".$FechaV."', '".$Total."', '".$Importee."', '".$ImpuestosT."', '".$ImpuestosR."', 'Competro', '".$Uuid."', '".$FP."', '".$cantidadnatural."')"; 
 ...
 //resta el total del estado de cuenta ya sea por el ciclo while o descontandolo directamente o ambas 
					...
					while($Importe>0){
						...
						//echo "<br>";
						//echo "Disponible: ";
						$GetPago = "SELECT Folio, Fecha, Disponible, Referencia FROM `movimientos` where Disponible > 0 and IdEmpresa = '".$IdEmpresa."' order by Fecha ASC limit 1";
