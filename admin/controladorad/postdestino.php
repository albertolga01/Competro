...
function Login()
{
	...
	global $connect;
		...
		$Permiso = $_POST["permiso"];  		$NoEstacion = $_POST["noestacion"];  
		
		
	    $query = "Insert into destinos (idempresa, iddestino, nombre, destino, direccion, permiso, noestacion) values ('".$IdEMpresa."','".$IdDestino."', '".$Nombre."','".$Destino."','".$Direccion."', '".$Permiso."', '".$NoEstacion."')";
