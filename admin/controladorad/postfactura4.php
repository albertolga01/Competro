...
function Uno(){
	...
	$FactQ = "Select Facturado from pedido where folio = '".$_POST["nopedido"][0]."'";
	echo $FactQ;
	...
	if ($resF->num_rows > 0) {
	    ...
	    if($Fact == 1){ 
			...
			$TipoPago = "Select Credito from estadocuenta where idempresa = '".$_POST["idempresa"][0]."'";
...
{  
	...
	$Factura = $_POST["factura"][0];
	$Fecha = $_POST["fecha"][0];
	$Total = $_POST["total"][0];
	$NoPedido = $_POST["nopedido"][0];
	$pdf = $_POST["pdf"][0];
	$flete = $_POST["flete"][0];
	$Concepto = $_POST["concepto"][0]; 
	$Rfc = $_POST["rfc"][0];
	$Descuento = $_POST["descuento"][0];
	$Cantidad = $_POST["cantidad"][0];
	$ValorUnitario = $_POST["valorunitario"][0];
	$Importee = $_POST["importe"][0];
	$ImpuestosT = $_POST["impuestostrasladados"][0];
	$ImpuestosR = $_POST["impuestosretenidos"][0];
	$Uuid = $_POST["uuid"];
	$FP = $_POST["FP"];
