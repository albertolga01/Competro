...
<div id="mainmenu">
<ul id="nav"><li class="bar"><a href="menu_cteadmin" class="baritem">Servicio a Clientes</a>
	</li>
...
<!-- FIN DEL ENCABEZADO --> 
			 ...
			 <div class="margin">
				<DIV id=pathway>
							...
							<SPAN class=bullet>&nbsp;&nbsp;</SPAN> 
							 <a  href="menu_cteadmin" >Servicio a clientes</a>&nbsp;<span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;<a  href="#" >Historial de notas de credito</a>
	...
	<div id="maincontent" align="center"> 	
       ...
       <form name="forma1" method="post" action="registrornotascredito.php">
...
$stringg = date('Y-m-d', strtotime($string));
  $sql = "Select t1.Folio, t1.empresa, t1.idempresa, t1.pdf, t1.concepto, t2.usuario, t1.NotaCredito, t1.Fecha, t1.Total from notascredito t1 inner join empresa t2 on t1.IdEmpresa = t2.IdEmpresa where date(Fecha) = '".$stringg."'";
$Totall = 0;
	$cont = 0;
...
die("Connection failed: " . $connect->connect_error);
  ...
  $sqld = "select date(fecha) as fecha from notascredito where date(fecha) >=  STR_TO_DATE('".$inicial."', '%d/%m/%Y') and date(fecha) <= STR_TO_DATE('".$final."', '%d/%m/%Y') group by date(fecha)";
...
$string = str_replace('/', '-', $Fecha); 
$stringg = date('Y-m-d', strtotime($string));
  $sql = "Select t1.Folio, t2.usuario, t1.NotaCredito, t1.empresa, t1.idempresa, t1.pdf, t1.concepto,  t1.Fecha, t1.Total from notascredito t1 inner join empresa t2 on t1.IdEmpresa = t2.IdEmpresa where date(Fecha) = '".$rowd['fecha']."'";
$result = $connect->query($sql);
