					...
					<SPAN class=bullet>&nbsp;&nbsp;</SPAN> 
						<A class=pwNoLink href="inicioadmin.php">Inicio</A> 
							<span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;
                             ...
                             <span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;
							 <a class=bold href="#">Referencias</a>
...
if (isset($_POST['idempresa'])) {
$sql = "SELECT idempresa, folio, cta, descripcion, tipo FROM cuentascontables where idempresa = '".$_POST['idempresa']."'";
$id = $_POST['idempresa'];
}else{$sql = "select idempresa, folio, cta, descripcion, tipo FROM cuentascontables";
$id = '0';
}
...
<td> <label>".$row["folio"]."</label></td>
<td>  <input type='text' name='cta' value ='".$row["cta"]."' size='17'   ></td>
<td>  <input type='text' name='descripcion' value ='".$row["descripcion"]."' size='22'   ></td>
<td>  <input type='text' name='tipo' value ='".$row["tipo"]."' size='11'   ></td>
<td></td>
</form>
</tr>";
}
...
echo "
<tr>
<form name='formaagregar' method='post' action='controladorad/postcuentacontable.php'> 
...
<td><input type='text' name='cta' value ='' size='17'   ></td>
<td><input type='text' name='descripcion' value ='' size='22'   ></td>
<td><select type='text' name='tipo' value =''  > 
...
if (isset($_POST['idempresa'])) {
$sql = "SELECT IdEmpresa, IdReferencia, Referencia, Banco, Descripcion FROM referencias where IdEmpresa = '".$_POST['idempresa']."'";
$id = $_POST['idempresa'];
}else{$sql = "select IdEmpresa, IdReferencia, Referencia, Banco, Descripcion from referencias";
$id = '0';
}
$result = $connect->query($sql);
if ($result->num_rows > 0) {
...
<form name='forma' method='post' action='controladorad/updatedestino.php'> 
<input type='hidden' name='idempresa' value=".$row["IdEmpresa"].">
<input type='hidden' name='idreferecia' value=".$row["IdReferencia"].">
<td height='24'> <label >".$row["IdEmpresa"]."</label> </td>
<td> <label>".$row["IdReferencia"]."</label></td>
<td>  <input type='text' name='referencia' value ='".$row["Referencia"]."' size='17'   ></td>
<td>  <input type='text' name='banco' value ='".$row["Banco"]."' size='16'   ></td>
<td>  <input type='text' name='descripcion' value ='".$row["Descripcion"]."' size='22'   ></td>
<td></td>
...
echo "
<tr>
<form name='formaagregar' method='post' action='controladorad/postreferencia.php'> 
<input type='hidden' name='idempresa' value=".$id.">
<td height='24'><label>".$id."</label></td>
<td><input type='text' name='idreferencia' value ='' size='4'  readonly></td>
<td><input type='text' name='referencia' value ='' size='17'   ></td>
<td><select type='text' name='banco' value =''  > 
