...
<!-- FIN DEL ENCABEZADO --> 
	...
	<!--Ruteo de la página-->
			 ...
			 <div class="margin">
				<DIV id=pathway>
							...
							<SPAN class=bullet>&nbsp;&nbsp;</SPAN> 
							 <a  href="menu_cteadmin" >Servicio a clientes</a>&nbsp;<span class='bullet'>&nbsp;&nbsp;&nbsp;</span>&nbsp;<a  href="#" >Historial de facturas</a>
       ...
       <form name="forma1" method="post" action="registrorfacturas.php">
...
<th style="height:25px; width:80px;  "  >Folio Pedido</th>
<th>Empresa</th>
<th>Usuario</th>
<th>Fecha Pedido</th>
...
$sql = "Select t3.folio as fol, t1.folio as fff,  t2.RzonSocial, t2.usuario, t1.Fecha, t1.Factura, t1.Concepto, t1.Total, t1.PDF from facturas t1 inner join empresa t2 on t1.IdEmpresa = t2.IdEmpresa inner join pedido t3 on t1.folio = t3.foliofactura where t1.folio  = '".$rowd["folio"]."' ";
...
<td><div align='center'  ><label>".$row["fol"]."</label></div></td>
<td><div align='center'><label>".$row["RzonSocial"]."</label></div></td>
