                ...
                <div id="maincontent" align="center"> 	
                    ...
                    <table align="center">
                        ...
                        <?php 
                            ...
                            if (isset($_POST['idempresa'])) {
                                $sql = "SELECT t1.IdEmpresa, t1.IdCondicion, t1.CentroEntrega, t1.Producto, t1.Destino, t1.Moneda, t1.MedioT, t1.TipoM, t1.Entrega, t1.Descripcion FROM condiciones t1 where t1.IdEmpresa = '".$_POST['idempresa']."'";
                                $id = $_POST['idempresa'];
                            } else {
                                $sql = "select IdEmpresa, IdDestino, Destino, Direccion from destinos";
                            }
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "
                                        ...
                                        <td>
                                            <div align='center'><label>".$row['Descripcion']."</label></div>
                                        </td>
                                        <td>  
                                ...
                                echo "
                                    ...
                                    <form name='formaagregar' method='post' action='controladorad/postcondicion.php'> 
                                        ...
                                        <input type='hidden' name='tipom' value='1'>
                                        <td height='24'>
                                            <label>".$_POST['idempresa']."</label>
                                        </td>
                                        <td>
                                            <input type='hidden' name='idcondicion' value =''  size='4'  readonly>
                                        </td>
                                        <td>
                                ";
                                echo "<select name='centroentrega'>";
                                ...
                                echo "
                                        ...
                                        <td>
                                            <div align='center'><input name = 'descripcion' required = 'required'></input></div>
                                        </td>
                                        <td>
                                            <select name='entrega' required='required' style=''>
                                    ...
                                    <form name='formaagregar' method='post' action='controladorad/postcondicion.php'> 
                                        ...
                                        <td>
                                            <select name='centroentrega' required='required'>     
                                                ...
                                                <option>647-TAD CULIACAN, SIN.</option>
                                                <option>645-TAD TOPOLOBAMPO, SIN.</option>
                                                <option>648-TAD GUAMUCHIL, SIN.</option>
                                                <option>614-TAD DURANGO, DGO.</option>
                                                <option>613-TAD GOMEZ PALACIO, DGO.</option>
                                                <option>633-TAD TEPIC, NAY.</option>
                                                <option>649-TAD LA PAZ, B.C.S.</option>
                                            </select>
                                        </td>
                                        <td>
...
<script>
    var pusher = new Pusher(
        '2d121696457cd9fb762b', {cluster: 'us3'}
    );
