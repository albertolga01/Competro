    ...
    <body class="body">
        ...
        <div id="contentfull" align="left">
            ...
            <div id="maincontent" align="center">
              ...
              <form method="post" name="formatimbrado" id="formatimbrado" action="sw/timbrar_manual">
                <?php
                  if(true){
						...
						if ($resultdx->num_rows > 0) { 
							...
							echo $rfccte;
                    		if($_POST['Concepto'][0] == 'GASOLINA CONTENIDO MIN.87 OCTANOS'){
							...
							if($_POST['Concepto'][0] == 'GASOLINA CONTENIDO MIN. 91 OCTANOS'){
								$Comision = $porcentajePremium/100;
								$LetraProd = 'P';
								$iepspremium = 0.550852;
								$cantidadlitros = $_POST['Cantidad'][0];
							...
							if($_POST['Concepto'][0] == 'DIESEL AUTOMOTRIZ'){
...
$descuento = $_POST['Descuento'][0];
  ...
  if($creditoOrContado == "1"){
	...
	echo '
				...
				<input type="submit" name="submitfac" value="Enviar">
                    ...
                    <table width="773" height="93" border="2">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input type="text" name="cliente"></td>
                      </tr>
                      <tr>
                        <td><label>R.F.C:</label></td>
                        <td width="254"><input type="text" name="rfc"></td>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input type="text", name="domicilio"></td>
                      </tr>
                      <tr>
                        <td><label>Lugar de entrega:</label></td>
                        <td colspan="3"><input type="text" name="lugarentrega"></td>
                      </tr>            
                    </table>
      ...
      if($i==1) {
          if ($_POST['ClaveProducto'][1] == 80141702) {
              echo'
          ...
          echo '
					<tr>
                      <td><input style="width:90px;" type="text" name="cantidad"></td>
                      <td><input style="width:90px;" type="text" name="unidad"></td>
                      <td><input style="width:90px;" type="text" name="claveunidadsat"></td>
                      <td><input style="width:90px;" type="text" name="claveprod"></td>
                      <td><input style="width:90px;" type="text" name="concepto"></td>
                      <td><input style="width:90px;" type="text" name="valorunitario"></td> 
                      <td><input style="width:90px;" type="text" name="descuentos"></td>
                      <td><input style="width:90px;" type="text" name="impuestos"></td>
                      <td><input style="width:90px;" type="text" name="importe"></td>
                    </tr>
					';
          ...
          $total = (($subtotal - $d) + $impuestostrasladados) - $_POST['ImpuestosRetenidos'];
                  ...
                  echo ' 
                    ...
                    <table width="774" border="1">
                      ...
                      <tr>
                        <td>Descuentos</td>
                        <td><input type="text" name="totaldescuentos"></td>
                      </tr>
                      <tr>
                        <td>Impuestos Translados</td>
                        <td><input type="text" name="impuestostraslados"></td>
                      </tr>
                      <tr>
                        <td>I.V.A. Retención Flete</td>
                        <td><input type="text" name="impuestosretenidos"></td>
                      </tr>
                      <tr>
                        <td>Total</td>
