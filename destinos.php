...
<td><input type='text' name='nombre' value ='' size='22'   ></td>
<td><input type='text' name='destino' value ='' size='22'   ></td>
<td><input type='text' name='direccion' value ='' size='35'   ></td>
<td><input type='text' name='permiso' value ='' size='20'   ></td>
<td><input type='text' name='noestacion' value ='' size='20'   ></td>
